...
class __TwigTemplate_15018604164e1cfbc64d7de5e750106e extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        yield "
    <button class=\"btn btn-primary mt-3 w-100 mb-3\">";
        // line 3
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Submit Question")) : ("Submit Question")), "html", null, true);
        yield "</button>
";
        // line 4
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-primary mt-3 w-100 mb-3\">{{ button_label|default('Submit Question') }}</button>
{{ form_end(form) }}
", "question/_form.html.twig", "/home/balcorn/public_html/brinker.bobbyalcorn.com/templates/question/_form.html.twig");
    }
}
